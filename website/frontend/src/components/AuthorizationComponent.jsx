        ...
        <div className='authorization'>
            ...
            <form className="form">
                ...
                <CustomInputComponent
                    ...
                    type="password"
                />
                <button onClick={handleSubmit} type="submit" style={{ background: '#9e9e9e', fontSize: '15px', fontWeight: 'bold', width: '100px', height: '35px', border: '2px', borderRadius: '9%', marginTop: '40px', marginLeft: 'auto', marginRight: 'auto' }}>Log In</button>
            </form>
